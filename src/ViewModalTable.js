    ...
    return (
        <Controller.TableController>
            ...
            <tr>
                ...
                <td>
                    {
                        items.medicine_type === "tablets" || items.medicine_type === "capsule" ?
                            items.concentration + "MG" : items.concentration + "ML"
                    }
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colSpan={3}>{!items.description ? "No description found" : items.description}</td>
            </tr>
            {
                declined ? (
                    <tr>
                        <td colSpan={4}>
                            <Controller.TextareaController onChange={(e) => setReason(e.target.value)} label="Batch Problem Description" />
                        </td>
                    </tr>
                ) : null
            }
            ...
            <tr>
                <td colSpan={4}>
                    {
                        declined ? (
                            <button onClick={ () => declineBatch(items.id, reason)}

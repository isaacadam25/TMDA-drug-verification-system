        ...
        <div className="col-md-12">
          <div className="container-fluid">
            <div className="row">
              ...
              <Route
                exact
                path="/tmda/data-entry/"
                component={() => <Dashboard profile={profile} />}
              />
              <Route
                path="/tmda/data-entry/register-batch"
                component={() => <RegisterBatch profile={profile} />}
              />
              <Route
                path="/tmda/data-entry/unapproved-batch"
                component={() => <UnapprovedBatches profile={profile} />}
              />
              <Route
                path="/tmda/data-entry/reports"
                component={() => <Reports profile={profile} />}
              />
              <Route
                path="/tmda/data-entry/profile"
